...
import './App.css'
import { Routes,Route, useNavigate, Link, Outlet, Navigate, useLocation } from 'react-router-dom'
...
const Login = ({logado, toggle}) => {
  ...
  return(
    <>
    {!logado && <h2>Parece que voce n'ao esta logado ainda, logue para continuar!</h2>}
    {
    logado 
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/*" element={<Login logado={logado} toggle={toggle}/>}/>
      </Routes>
